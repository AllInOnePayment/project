...
$table->foreign('student_id')->references('student_id')->on('schools')->onDelete('cascade');
$table->foreign('service_number')->references('service_number')->on('service_providers')->onDelete('cascade');
