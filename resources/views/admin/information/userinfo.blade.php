        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Mobile Bank</span>
		...
		<div class="card card-default">
		  ...
		  <div class="card-body">
		    <div class="callout callout-info">
		      <h5>Their are <b>{{$sc}}</b> registered services</h5>
...
<!-- END ALERTS AND CALLOUTS -->
	...
	<div class="row">
		...
		@foreach($systemlist as $sl)
			<div class="form-control bg-info">{{$sl->service_name}}</div>
			<div class="row">
				<div class="col-sm-1"></div>
				<div class="col-sm-6">
					@foreach($sl->user as $u)
					    @if($u->service_id == 1)
