...
<section class="container-fluid"><hr>
    <a href="{{ route('admin.manager.create')}}" class="btn btn-primary text-white">Add Manager</a><hr>
  <div class="container">
    <table class="table table-rounded table-striped">
      ...
      <tr>
        ...
        <th><a class="btn btn-warning" href="{{ route('admin.manager.edit',$m->id)}}">Edit</a> 
        </th>
      </tr>
        @endforeach
    </table>
